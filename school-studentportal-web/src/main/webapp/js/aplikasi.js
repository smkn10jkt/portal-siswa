angular.module('belajar', ['ui', 'belajar.controller'])
    .config(['$routeProvider', function($routeProvider){
        $routeProvider
			...
			.when('/list/student', {templateUrl: 'pages/list/class.html'})
            ...
            .when('/laporan/RekapHarian', {templateUrl: 'pages/laporan/RekapHarian.html'})
            .when('/laporan/RekapBulanan', {templateUrl: 'pages/laporan/RekapBulanan.html'})
